...
2026 年 3 月，国家网信安全中心（CNCERT）专门发布过关于 AI Agent 提示词注入风险的预警，OpenClaw 也被点名提到过。这个风险是真实存在的，所以一定要防。
...
下面这些不是"假想"，而是 2025-2026 年真实发生过的安全事件。了解它们，你才知道为什么安全这么重要。

### 案例一：ClawHavoc 恶意技能运动

2025 年底，安全研究人员发现 ClawHub 上存在一场有组织的恶意技能投放行动，被称为 **ClawHavoc**。攻击者在 ClawHub 上传了 **824 个恶意技能**，一度占 ClawHub 全部技能的近 **20%**。
...
2026 年 2 月，安全研究员在 OpenClaw 的 MCP 工具调用机制中发现了一个严重漏洞（编号 CVE-2026-25253）。攻击者可以通过精心构造的技能文件，让 OpenClaw 执行任意代码——也就是说，一个恶意技能可以在你的电脑上做任何事情。
